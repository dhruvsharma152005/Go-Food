...
//dispatch:-Its job is to send an action to the reducer.
...
const priceRef=useRef();
  ...
  {
    //for update means already ha usko bs badana ha
    let food=[];
  ...
  <img src={props.foodItem.img} className="card-img-top" alt="..." style={{height:"128px",objectFit:"fill"}}/>
  <div className="card-body">
    <h5 className="card-title">{props.foodItem.name}</h5> 
    {/* //from home.js foodname come  */}
